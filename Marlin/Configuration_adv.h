...
//#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_DURATION_SEC    20     // (minutes) Time without extruder movement to trigger protection
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.42    // Unit: mm compression per 1mm/s extruder speed
